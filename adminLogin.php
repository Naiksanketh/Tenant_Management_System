    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ownerLogin.php">Owner</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="tenantLogin.php">Tenant</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="overlay">
      <form action="" name="myForm" method="post">
        ...
        <div class="mb-3">
          ...
          <input class="form-control" type="email" id="email" placeholder="xyz@gmail.com" name="email" required>
        </div>
        <div class="mb-3">
          <label class="form-label" for="pass">PASSWORD</label>
          <input class="form-control" type="password" id="pass" placeholder="&!*#^#&#" name="pass" required>
        </div>
        <div class="mb-3">
  ...
  <footer class="footer footer-distributed sticky-bottom">
    ...
    <div class="footer-right">
      ...
      <p style="color: #8f9296; font-size: 14px; margin-bottom: 2rem;">
        Management of your buildings, apartments, tenants and rentals at one place.
      </p>
    ...
    <div class="footer-left">
      ...
      <p>Copyright © 2022 Yenepoya Group - Estate Management System.</p>
    </div>
